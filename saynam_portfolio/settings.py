"""
Django settings for saynam_portfolio project.
...
SECRET_KEY = 'django-insecure-78hvi_u7r^e-vn1r=un-2^m34xti(k*cns^bo@_77a*x-i9=pv'
...
ROOT_URLCONF = 'saynam_portfolio.urls'
...
WSGI_APPLICATION = 'saynam_portfolio.wsgi.application'
